...
const MODULES = [
  { id:'catalogue', icon:'📚', title:'Catalogue', desc:'Formations & tarifs personnalisés', href:'/catalogue', color:'#a855f7' },
  ...
  { id:'visio', icon:'🎥', title:'ANZPilot Visio', desc:'Visioconf\u00e9rence int\u00e9gr\u00e9e', href:'/visio', color:'#06b6d4' },
  { id:'classes', icon:'📅', title:'Sessions virtuelles', desc:'Planifier vos visios', href:'/classes-virtuelles', color:'#8b5cf6' },
