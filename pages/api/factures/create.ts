...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const { data, error } = await sb.from('factures').insert({
      ...
      destinataire_type:d.destinataire_type, destinataire_nom:d.destinataire_nom, destinataire_siret:d.destinataire_siret, destinataire_adresse:d.destinataire_adresse, destinataire_email:d.destinataire_email, destinataire_reference:d.destinataire_reference,
      apprenant_nom:d.apprenant_nom, formation_titre:d.formation_titre,
      date_formation_debut:d.date_formation_debut||null, date_formation_fin:d.date_formation_fin||null,
