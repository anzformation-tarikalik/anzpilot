        ...
        <div style={{ maxWidth:900, margin:'0 auto' }}>
            ...
            <>
              <div style={card}>
                ...
                <div style={{ marginTop:16, display:'grid', gridTemplateColumns:'1fr', gap:14 }}>
                  {Field({ label: "Numéro du document", k: "numero", required: true })}
                </div>
              </div>
              ...
              <div style={card}>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:14 }}>
                  {Field({ label: "Raison sociale", k: "of_nom", required: true })}
                  {Field({ label: "SIRET", k: "of_siret", required: true, placeholder: "123 456 789 00012" })}
                  {Field({ label: "Numéro de déclaration (NDA)", k: "of_nda", required: true, placeholder: "11 75 12345 75" })}
                  ...
                  {Field({ label: "Adresse complète", k: "of_adresse", full: true, placeholder: "123 rue de la Formation, 75001 Paris" })}
                </div>
              </div>
            </>
          )}
            ...
            <>
              <div style={card}>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'auto 1fr 1fr', gap:14 }}>
                  ...
                  {Field({ label: "Prénom", k: "apprenant_prenom", required: true })}
                  {Field({ label: "Nom", k: "apprenant_nom", required: true })}
                </div>
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:14, marginTop:14 }}>
                  {Field({ label: "Email", k: "apprenant_email", type: "email", required: true })}
          ...
          {step === 3 && (
            <div style={card}>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:14 }}>
                {Field({ label: "Titre de la formation", k: "formation_titre", required: true, full: true, placeholder: "Excel Avancé pour Comptables" })}
                {Field({ label: "Date de début", k: "date_debut", type: "date", required: true })}
                {Field({ label: "Date de fin", k: "date_fin", type: "date", required: true })}
                {Field({ label: "Durée (heures)", k: "duree_heures", type: "number", required: true, placeholder: "21" })}
                ...
                {Field({ label: "Objectifs pédagogiques", k: "formation_objectifs", type: "textarea", required: true, full: true, placeholder: "À l'issue de cette formation, l'apprenant sera capable de..." })}
                {Field({ label: "Programme détaillé", k: "formation_programme", type: "textarea", full: true, placeholder: "Jour 1: Introduction\nJour 2: Approfondissement\nJour 3: Cas pratiques" })}
              </div>
            </div>
          )}
          ...
          {step === 4 && (
            <div style={card}>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:14 }}>
                {Field({ label: "Prix HT (€)", k: "prix_ht", type: "number", required: true, placeholder: "2000" })}
