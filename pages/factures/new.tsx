        ...
        <div style={{ maxWidth:900, margin:'0 auto' }}>
            ...
            <>
              ...
              <div style={card}>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:14 }}>
                  <F label="Raison sociale" k="destinataire_nom" required placeholder={form.destinataire_type==='opco'?'AFDAS, OPCO EP, etc.':'Nom complet'}/>
                  ...
                  <F label="Adresse complète" k="destinataire_adresse" full/>
                </div>
              </div>
              <div style={card}>
                <h3 style={{ fontSize:15, fontWeight:600, color:'#fff', marginBottom:14 }}>🏢 Vos coordonnées (émetteur)</h3>
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:14 }}>
                  <F label="Raison sociale" k="of_nom" required/>
                  <F label="SIRET" k="of_siret" required/>
          ...
          {step===2 && (
            <div style={card}>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:14 }}>
                <F label="Numéro de facture" k="numero" required/>
                <F label="Apprenant concerné" k="apprenant_nom" required full placeholder="Jean Dupont"/>
                <F label="Titre de la formation" k="formation_titre" required full/>
                ...
                <F label="Date d'émission" k="date_emission" type="date" required/>
                <F label="Date d'échéance" k="date_echeance" type="date" required/>
                <F label="Modalités de paiement" k="modalites_paiement" full/>
              </div>
            </div>
          )}
          ...
          {step===3 && (
            <div style={card}>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:14 }}>
                <F label="Prix HT (€)" k="prix_ht" type="number" required placeholder="2000"/>
